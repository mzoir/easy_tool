...
try:
  requests.get("https://m.facebook.com")
	...
	print color.RED
	print"[+]CHECK YOUR CONNECTION INTERNET AND RE RUN PORGRAM"
	exit()
...
def FB(x): 
   if x=="3":
	print color.RED
	print""" LIST OF TOOL OF HACKING FACEBOOK (ROOT)
	   {} [1] FACEBASH
	   {} [2] OSIF
	   {} [3] FBHACK
	   {} [4] FAITAGRAM
	   {} [99] BACK TO MAIN
	    [00] exit
	    """.format(color.UNDERLINE,color.BLUE,color.END,color.CYAN,color.YELLOW)
	print color.END
	h = raw_input("CHOICE ON ACION:")
	if h=="99":
		option()
	elif h=="00":
                  print color.RED
		...
		print"INSTALLING....\033[1mFACEBASH"
		print color.END
		print"THIS TOOL HACK FB BY TOR(CHANGE IP)"
		time.sleep(2)
		print color.BLUE						
		os.system("""
cd ..
...
""")
		...
		print color.PURPLE
		print"==>RUN PROGRAM BY TYPING ./facebash.sh"
		FB(x)
	elif h=="2":	   			 			
		print color.GREEN		
                print"INSTALLING....{}OSIF".format(color.PURPLE)
		time.sleep(2)
                print color.END				 
		print"THIS TOOL FOR CONTROL YOUR FACEBOOK"
		print color.BLUE
		os.system("cd ..")
		os.system("git clone https://github.com/CiKu370/OSIF")
		print color.YELLOW
		print"==>RUN TOOL BY TYPE python2 osif.py"
		FB(x)
 	elif h=="3":
		print color.CWHITE
		print"INSTALLING......{}FBHACK".format(color.RED)
		time.sleep(2)
		print color.END
		print"THIS TOOL FOR HACK FB FACEBOOK"
		time.sleep(2)
		os.system("""
cd ..
...
""")
		print color.PURPLE
		print"RUN TOOL BY TYPING python2 dark.py"		
    		FB(x)

	elif h=="4":
		print color.CWHITE
                print"INSTALLING......\033[0;37;44mFAITAGRAM"
                time.sleep(2)
                print color.END
        	print"THIS TOOL FOR HACKING SOCIAL MEDIA"
		os.system("""
cd ..
...
python setup.py
""")
  		print"==>RUN TOOL BY TYPING ./Faitagram"
